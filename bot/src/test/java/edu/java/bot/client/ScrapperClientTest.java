...
public class ScrapperClientTest {
    ...
    public void linksShouldReturnCorrectValue() {
            ...
            get(urlPathMatching("/links"))
                ...
                .willReturn(aResponse()
                    ...
                    .withBody(objectMapper.writeValueAsString(new ListLinksResponse(
                        List.of(new LinkResponse(100L, URI.create("https://github.com/AirstaNs"))),
                        1
                    )))
                )
        );
        ...
        Assertions.assertThat(response)
                  ...
                  .isEqualTo(List.of(new LinkResponse(100L, URI.create("https://github.com/AirstaNs"))));
    }
    ...
    public void linksPostShouldReturnAddedLink() {
            ...
            post(urlPathMatching("/links"))
                ...
                .willReturn(aResponse()
                    ...
                    .withBody(objectMapper.writeValueAsString(new LinkResponse(
                        100L,
                        URI.create("https://github.com/AirstaNs")
                    )))
                )
        );
        ...
        LinkResponse response =
            scrapperClient.addLink(100L, new AddLinkRequest(URI.create("https://github.com/AirstaNs"))).answer();
        Assertions.assertThat(response)
                  .extracting(LinkResponse::id, LinkResponse::url)
                  .contains(100L, URI.create("https://github.com/AirstaNs"));
    }
